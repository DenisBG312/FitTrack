        ...
        <div className="hidden md:flex md:items-center md:space-x-8">
          ...
          {isAuthenticated && (
            <Link
              ...
              className="relative group flex items-center gap-2 font-medium text-gray-200 hover:text-white"
            >
              <FaUsers size={20} className="text-yellow-500 group-hover:animate-pulse" />
              <span>Community</span>
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
            </Link>
          )}
        ...
        <div className="flex flex-col space-y-4 px-6 py-4 bg-gray-800 border-t border-gray-700">
          ...
          {isAuthenticated && (
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
            >
              <FaCompass size={20} className="text-yellow-500" /> Find Gyms
            </Link>
          )}
          ...
          {isAuthenticated && (
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
            >
              <FaUsers size={20} className="text-yellow-500" /> Community
            </Link>
          )}
